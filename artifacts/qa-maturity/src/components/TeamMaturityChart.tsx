...
interface TeamMaturityChartProps {
  data: SnapshotData[];
  isLoading: boolean;
}
...
export function TeamMaturityChart({ data, isLoading }: TeamMaturityChartProps) {
  ...
  const chartData = data.map(d => ({
    date: d.date,
    level0: d.teamDistribution[0],
    level1: d.teamDistribution[1],
    level2: d.teamDistribution[2],
    level3: d.teamDistribution[3],
  }));
